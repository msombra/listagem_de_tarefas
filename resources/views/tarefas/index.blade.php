...
<body>
    ...
    <div class="container w-50 mx-auto mt-5">
                    ...
                    @foreach ($tarefas as $tarefa)
                        <li class="list-group-item d-flex justify-content-between align-items-start hover-item">
                            ...
                            <div class="d-flex justify-content-center gap-2">
                                {{-- BOTÃO CONCLUIR --}}
                                <div class="">
                                    <a href="{{ route('tarefas.completed', $tarefa->id) }}" class="btn btn-success" title="Marcar como concluída">
                                ...
                                {{-- BOTÃO EDITAR --}}
                                <div class="">
                                    <a href="{{ route('tarefas.edit', $tarefa->id) }}" class="btn btn-warning" title="Editar tarefa">
                                ...
                                <div class="">
                                    <form action="{{ route('tarefas.destroy', $tarefa->id) }}" method="post">
                                        @csrf
                                        @method('delete')
                                        <button type="submit" class="btn btn-danger" title="Excluir tarefa">
        ...
        <div class="d-flex justify-content-between mt-3">
            <div>
                <a href="{{ route('tarefas.completed_list') }}" class="btn btn-primary" title="Mostrar tarefas concluídas">
